...
parser.add_argument('-n','--name', help='Test name, use "strategy" as name to print a summary report per strategy ', required=True)
...
for dfstrategy in backtest_collection.iterate_by_strategy():
    ...
    path = pr.backtest_reports("summary",csv_name)
